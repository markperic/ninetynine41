...
export function Hero() {
  return (
    <section className="relative flex min-h-[85vh] flex-col justify-between overflow-hidden bg-brand-green px-6 pt-10 pb-14 sm:pt-14">
      <Image
      ...
      {/* vertical social labels, right edge */}
      <div className="pointer-events-none absolute top-1/2 right-4 hidden -translate-y-1/2 flex-col items-center gap-10 text-xs font-semibold tracking-[0.3em] text-white/70 [writing-mode:vertical-rl] sm:flex">
        <span>INSTAGRAM</span>
        <span>FACEBOOK</span>
      </div>
