    ...
    >
      <div className="relative flex w-full items-center justify-between">
        ...
        <div className={`flex shrink-0 items-center gap-4 ${dark ? "text-zinc-950" : "text-white"}`}>
          <a href={facebookUrl} aria-label="Facebook" className="hidden transition-opacity hover:opacity-70 sm:block">
            <FacebookIcon className="h-4 w-4" />
          </a>
          <a href={instagramUrl} aria-label="Instagram" className="hidden transition-opacity hover:opacity-70 sm:block">
